...
func App() *buffalo.App {
	if app == nil {
		...
		app.Resource("/identity_entitlements", IdentityEntitlementsResource{&buffalo.BaseResource{}})
		app.Resource("/identity_groups", IdentityGroupsResource{&buffalo.BaseResource{}})
	}
